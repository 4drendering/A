...
// Filename: ARMAN.ggsk
// Generated Sun Jan 22 05:07:26 2017
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._text_1__text.innerHTML="OPEN";
		...
		this._text_11__text.innerHTML="CLOSED";
		this._text_11.appendChild(this._text_11__text);
		this._text_1.appendChild(this._text_11);
		...
		this._text_10__text.innerHTML="FRONT";
		this._text_10.appendChild(this._text_10__text);
		this._text_1.appendChild(this._text_10);
		...
		this._button_1__img.setAttribute('src',basePath + 'images/button_1.jpg');
